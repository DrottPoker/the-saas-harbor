...
- A home page for founders: a compact header invites every SaaS to list for free, verified or not, with a button straight to sign-up, and shows the next open place on the leaderboard (#1 while none is taken) for those who connect their payment provider; the leaderboard follows at once. A new account lands on the product form once its email is confirmed.
