...
- Site statistics, counted without cookies: an Analytics page in the admin panel (`/admin/analytics`) with visitors, visits and page views over 24 hours to 12 months, the most viewed pages, sources and campaigns, countries, devices, browsers and operating systems, from our own database; and Vercel Web Analytics and Speed Insights (page load times) in production, read in the Vercel dashboard. Bots, admin pages and signed-in admins are left out, and addresses keep only their campaign tags.
