...
- A home page for founders: what listing a product gives, how early they are on the leaderboard, three steps to a listing and a button straight to sign-up. A new account lands on the product form once its email is confirmed. The leaderboard follows under it.
