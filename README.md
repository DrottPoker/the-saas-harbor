...
- Revenue verified through a read-only key to the product's payment provider (Stripe, Paddle, Polar or Dodo Payments, one per product): MRR and paying customers are read from the provider, never typed in, and re-verified daily.
