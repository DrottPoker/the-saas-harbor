...
- Site statistics through Vercel Web Analytics in production: cookieless page views, sources, countries and devices in the Vercel dashboard. Admin pages are not measured, and addresses keep only their campaign tags.
