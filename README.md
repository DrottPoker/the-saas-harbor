...
- Account deletion by the maker, confirmed with the password: profile, products, images, Stripe keys, verification history and sign-in records are removed.
